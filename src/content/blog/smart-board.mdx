---
title: 'smart board'
description: 'a desktop-based Kanban-style application for managing personal work with task management, drag-and-drop functionality, and SQLite persistence'
pubDate: 'Apr 02 2022'
