---
title: "hart: next.js artwork portfolio and shop"
...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
  <figure>
    <img
      class="rounded-md"
      src="/blog/hart/admin-dashboard.webp"
      alt="admin dashboard"
    />
    <figcaption class="mt-2 font-mono text-xs text-(--text-secondary)">
      admin dashboard
  ...
  <figure>
    <img
      class="rounded-md"
      src="/blog/hart/create-drawing.webp"
      alt="create drawing modal"
    />
    <figcaption class="mt-2 font-mono text-xs text-(--text-secondary)">
...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
  ...
  <figure>
    <img
      class="rounded-md"
      src="/blog/hart/archived-messages.webp"
      alt="archived messages page"
    />
    <figcaption class="mt-2 font-mono text-xs text-(--text-secondary)">
