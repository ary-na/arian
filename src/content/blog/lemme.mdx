---
title: 'lemme: natural language to shell commands cli'
description: 'A natural language CLI that translates plain English into shell commands, powered by Claude, OpenAI, Groq, or Gemini'
pubDate: 'May 20 2026'
...
```bash
# ai
@anthropic-ai/sdk | openai | groq-sdk | @google/genai
```
