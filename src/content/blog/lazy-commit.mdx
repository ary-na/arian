---
title: 'lazy-commit: ai-powered git commit message cli'
description: 'A tiny Node.js CLI for generating AI-powered conventional commit messages with dry-run mode, editing, and confirmation prompts'
pubDate: 'May 14 2026'
